...
func createImages() (*gcp_client.GcpServices, error) {
...
func TestImages(t *testing.T) {
	gcp_client.MockTestHelper(t, table_schema_generator.GenTableSchema(&TableGcpComputeImagesGenerator{}), createImages, gcp_client.TestOptions{})
}
