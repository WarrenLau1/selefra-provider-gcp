...
func createServiceAccounts() (*gcp_client.GcpServices, error) {
...
func TestServiceAccounts(t *testing.T) {
	gcp_client.MockTestHelper(t, table_schema_generator.GenTableSchema(&TableGcpIamServiceAccountsGenerator{}), createServiceAccounts, gcp_client.TestOptions{})
}
