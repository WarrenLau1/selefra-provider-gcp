...
var _ table_schema_generator.TableSchemaGenerator = &TableGcpIamServiceAccountsGenerator{}

func (x *TableGcpIamServiceAccountsGenerator) GetTableName() string {
	return "gcp_iam_service_accounts"
}

func (x *TableGcpIamServiceAccountsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableGcpIamServiceAccountsGenerator) GetVersion() uint64 {
	return 0
}
...
func (x *TableGcpIamServiceAccountsGenerator) GetSubTables() []*schema.Table {
	return []*schema.Table{
		table_schema_generator.GenTableSchema(&TableGcpIamServiceAccountKeysGenerator{}),
	}
}
